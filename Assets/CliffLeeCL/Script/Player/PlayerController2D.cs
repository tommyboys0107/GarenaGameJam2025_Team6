...
namespace CliffLeeCL
{
    ...
    public class PlayerController2D : MonoBehaviour
    {
        ...
        private void UpdateMovementPlatformer()
        {
            ...
            {
                rigid.linearVelocity = new Vector2(sprintVelocity.x, rigid.linearVelocity.y);
            ...
            {
                rigid.linearVelocity = new Vector2(moveVelocity.x, rigid.linearVelocity.y);
                isSprinting = false;
            }
        }
        ...
        private void UpdateMovementTopDown()
        {
            ...
            if (canSprint && isSprintKeyPressed && (status.currentStamina > 0))
            {
                rigid.linearVelocity = new Vector2(sprintVelocity.x, sprintVelocity.y);
                if (sprintVelocity.sqrMagnitude > Mathf.Epsilon)// Is really moving.
                    isSprinting = true;
                else
                    isSprinting = false;
            ...
            {
                rigid.linearVelocity = new Vector2(moveVelocity.x, moveVelocity.y);
                isSprinting = false;
            }
        }
